         ...
         <div className="flex justify-between ">
            <div className="min-w-72 border-t hidden xl:flex flex-col p-6 gap-6">
                ...
                <div className="flex gap-2 items-center bg-blue-600 text-white px-2 py-3 rounded-lg">
                    <Image className="size-6" src='/images/home.png' alt="home-icon" width={100} height={100} />
                    Dashboard
                </div>
                <div className="flex gap-2 text-[#90A3BF] text-sm items-center px-2 ">
                    <Image className="size-6" src='/images/caricon.png' alt="car-icon" width={100} height={100} />
                    Car Rent
                </div>
                <div className="flex gap-2 text-[#90A3BF] text-sm items-center px-2 ">
                    <Image className="size-6" src='/images/insight.png' alt="car-icon" width={100} height={100} />
                    Insight
                </div>
                <div className="flex gap-2 text-[#90A3BF] text-sm items-center px-2 ">
                    <Image className="size-6" src='/images/wallet.png' alt="car-icon" width={100} height={100} />
                    Reimburse
                </div>
                <div className="flex gap-2 text-[#90A3BF] text-sm items-center px-2 ">
                    <Image className="size-6" src='/images/inbox.png' alt="car-icon" width={100} height={100} />
                    Inbox
                </div>
                <div className="flex gap-2 text-[#90A3BF] text-sm items-center px-2 ">
                    <Image className="size-6" src='/images/calender.png' alt="car-icon" width={100} height={100} />
                    Calender
                </div>
                ...
                <div className="flex gap-2 text-[#90A3BF] text-sm items-center px-2 ">
                    <Image className="size-6" src='/images/settingicon.png' alt="settings-icon" width={100} height={100} />
                    Settings
                </div>
                <div className="flex gap-2 text-[#90A3BF] text-sm items-center px-2 ">
                    <Image className="size-6" src='/images/help.png' alt="help-icon" width={100} height={100} />
                    Help & Center
                </div>
                <div className="flex justify-between text-[#90A3BF] text-sm items-center px-2 ">
                    ...
                    <Image className="w-14 h-6" src='/images/darkmod.png' alt="darkmode-icon" width={100} height={100} />
                </div>
                ...
                <div className="flex items-start gap-6 flex-col lg:flex-row">
                    <div className="bg-white p-6 rounded-xl h-fit flex flex-col gap-6 w-full lg:w-1/2 lg:min-w-[24rem]">
                        <div className="flex gap-6 flex-col">
                            ...
                            <div className="">
                                <Image className="object-cover w-full" src={'/images/map.png'} alt="car-img" width={200} height={200} />
                            </div>

                            <div className="flex gap-4 items-center">
                                <Image className="w-28 h-14 object-cover rounded-lg" src={'/images/bgwithcar.png'} alt="car-img" width={100} height={100} />
                    ...
                    <div className="rounded-xl size-full flex flex-col gap-6 lg:w-1/2 lg:min-w-[24rem]">
                        <div className="bg-white p-6 rounded-xl flex flex-col gap-6">
                            <div className="flex gap-6 flex-col">
                                ...
                                <div className="">
                                    <Image className="object-cover w-ful" src={'/images/graphs.png'} alt="car-img" width={500} height={500} />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex gap-6 flex-col bg-white p-7 rounded-lg">
                            ...
                            <div className="flex gap-4 items-center">
                                <Image className="w-28 h-14 object-contain rounded-lg" src={'/images/nisan.png'} alt="car-img" width={100} height={100} />
                            ...
                            <div className="flex gap-4 items-center">
                                <Image className="w-28 h-14 object-contain rounded-lg" src={'/images/deep.png'} alt="car-img" width={100} height={100} />
                                <div className="relative flex flex-col w-full" >
                                    <div className="text-xl font-bold flex items-center justify-between">
                                        <div>Nissan GT - R</div>
                                        <div>
                            ...
                            <div className="flex gap-4 items-center">
                                <Image className="w-28 h-14 object-contain rounded-lg" src={'/images/rollsroyce.png'} alt="car-img" width={100} height={100} />
                                <div className="relative flex flex-col w-full" >
                                    <div className="text-xl font-bold flex items-center justify-between">
                                        <div>Nissan GT - R</div>
                                        <div>
                            ...
                            <div className="flex gap-4 items-center">
                                <Image className="w-28 h-14 object-contain rounded-lg" src={'/images/jeep.png'} alt="car-img" width={100} height={100} />
                                <div className="relative flex flex-col w-full" >
                                    <div className="text-xl font-bold flex items-center justify-between">
                                        <div>Nissan GT - R</div>
                                        <div>
