            ...
            <div className="w-[95vw] flex gap-6 flex-col-reverse lg:flex-row">
                <div className="w-full flex flex-col gap-6">
                    ...
                    <div className="bg-white p-6 rounded-xl  flex flex-col gap-6">
                        ...
                        <div className="flex flex-col gap-6 bg-[#f6f7f9] p-6 rounded-lg">
                            <div className="flex items-center mb-2 justify-between">
                                ...
                                <Image className="h-4 w-16" src={'/images/visa.png'} alt="visa-icon" width={100} height={100} />
                        ...
                        <div className="flex justify-between gap-2 bg-[#f6f7f9] text-xs py-4 px-6 rounded-md">
                            <div className="flex gap-4">
                                <Image className="w-4" src={'/images/emptyball.png'} alt="ball-icon" width={100} height={100} />
                                <div className="font-bold">Paypal</div>
                            </div>
                            <Image className="h-4 w-16" src={'/images/paypal.png'} alt="paypal-icon" width={100} height={100} />
                        </div>
                        <div className="flex justify-between gap-2 bg-[#f6f7f9] text-xs py-4 px-6 rounded-md">
                            <div className="flex gap-4">
                                <Image className="w-4" src={'/images/emptyball.png'} alt="ball-icon" width={100} height={100} />
                            ...
                            <Image className="h-4 w-16" src={'/images/bitcoin.png'} alt="bitcoin-icon" width={100} height={100} />
                        </div>
                    ...
                    <div className="bg-white p-6 rounded-xl  flex flex-col gap-6">
                        ...
                        <div className="flex justify-between gap-2 bg-[#f6f7f9] text-xs py-4 px-6 rounded-md">
                            <div className="flex gap-4">
                                <Image className="w-4" src={'/images/box.png'} alt="box-icon" width={100} height={100} />
                        ...
                        <div className="flex flex-col gap-4">
                            <Image className="w-6" src={'/images/checkshield.png'} alt="checkshield-icon" width={100} height={100} />
                ...
                <div className="bg-white p-6 rounded-xl h-fit flex flex-col gap-6 lg:w-1/2 lg:min-w-[24rem]">
                    ...
                    <div className="flex gap-4 items-center">
                        <Image className="size-28" src={'/images/bgwithcar.png'} alt="car-img" width={100} height={100} />
